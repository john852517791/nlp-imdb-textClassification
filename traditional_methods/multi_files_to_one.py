...
def write_to_one(dir, o_file_name):
    ...
    with open(o_file_name, 'w') as fout:
        ...
        for ex in exampels:
            try:
                fout.write("{}\t{}\n".format(ex.label, ex.text_a.replace('\t', '')))
...
if __name__ == "__main__":
    write_to_one("../deeplearning/.data/imdb/aclImdb/train", '../deeplearning/.data/imdb/aclImdb/train.txt')
    write_to_one("../deeplearning/.data/imdb/aclImdb/test", "../deeplearning/.data/imdb/aclImdb/test.txt")
